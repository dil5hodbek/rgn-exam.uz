...
import { BookOpenCheck, FileCheck2, GraduationCap, Users } from "lucide-react";
...
export default function AdminOverview() {
  ...
  const stats = [
    { label: "Registered students", value: overview.students, icon: Users, tone: "bg-orange-500/10 text-orange-500" },
    { label: "Tests", value: overview.tests, icon: BookOpenCheck, tone: "bg-emerald-500/10 text-emerald-500" },
  ...
  return <div className="mx-auto max-w-7xl p-4 sm:p-8"><div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end"><div><p className="text-xs font-bold uppercase tracking-[.18em] text-brand">Live database</p><h1 className="mt-2 text-3xl font-extrabold text-ink">Admin Overview</h1><p className="mt-2 text-sm text-muted">Create and manage tests, then publish them to students.</p></div><div className="flex gap-2"><Link href="/admin/tests"><Button>Manage Tests</Button></Link></div></div>
