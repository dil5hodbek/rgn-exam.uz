...
export default function ForgotPassword() {
  ...
  async function requestCode() {
    ...
    try {
      await api("/auth/telegram/request-otp", { method: "POST", body: JSON.stringify({ phone_number: phone, purpose: "reset" }) });
